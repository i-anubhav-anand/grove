...
struct GeneralSettingsTab: View {
    ...
    private func notificationsSection(appState: Binding<Bool>) -> some View {
        toggleSection(
            ...
            detail: "Sends a system notification while Grove is in the background.",
            isOn: appState
        )
    }
    ...
    private var sourceCodeSection: some View {
        Link(destination: URL(string: "https://github.com/grove/Grove")!) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    Text("Open Source")
                        .font(.system(size: ClaudeTheme.size(13)))
                        .foregroundStyle(.primary)
                    Text(verbatim: "github.com/grove/Grove")
                        .font(.system(size: ClaudeTheme.size(11)))
                        .foregroundStyle(.secondary)
                }
                Spacer()
