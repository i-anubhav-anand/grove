        ...
        case .attachments:
            [
                ...
                ManualSection(
                    ...
                    body: "Pasting (⌘V) is smart — Grove detects what's in the clipboard and handles it automatically.",
                    items: [
        ...
        case .github:
            [
                ManualSection(
                    ...
                    body: "Click the GitHub Mark button at the top of the sidebar to open the GitHub panel. After connecting your GitHub account, your repositories are listed and can be added to Grove with one click."
                ),
                ManualSection(
                    title: "Adding a Repository",
                    body: "Search for a repository by name, then click Add. Grove clones it automatically and opens it as a new project.",
                    items: [
                        ...
                        KeyValueItem(key: "checkmark", value: "Already added to Grove", symbolName: "checkmark.circle.fill", symbolColor: .green),
                    ]
                ),
            ]
        ...
        case .settings:
            [
                ManualSection(
                    ...
                    body: "Choose Grove → Settings from the menu bar or press ⌘, to open the Settings window. Settings are organized into four tabs: General, Message, Slash Commands, and Shortcuts."
                ),
                ManualSection(
                    title: "General Tab",
                    ...
                    items: [
                        ...
                        KeyValueItem(key: "Notifications", value: "Show a system notification when a response completes while Grove is in the background"),
                    ],
                ...
                ManualSection(
                    title: "Themes",
                    body: "Grove ships with six accent color themes. Preview each one directly from the theme picker — the whole app recolors live as you choose.",
                    items: [
                ...
                ManualSection(
                    ...
                    body: "Open Grove → Check for Updates… to run Sparkle's update check manually. Updates are also checked automatically on launch."
                ),
            ]
        }
    }
