...
public enum SlashCommandRegistry {
    ...
    private static func exportCommentHeader() -> String {
        let commentLines = [
            String(localized: "Grove slash command export file.", bundle: .module),
            ...
            String(localized: "The leading slash is optional while editing names; Grove saves names without it.", bundle: .module),
