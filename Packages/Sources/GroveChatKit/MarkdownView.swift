...
private final class RenderGroupCache: @unchecked Sendable {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(forName: .groveThemeDidChange, object: nil, queue: .main) { [weak self] _ in
...
struct MarkdownContentView: View {
    ...
    private static func fontForHeading(_ level: Int) -> Font {
        ...
        case 3: return .system(size: base + 1, weight: .semibold)
        default: return .system(size: base, weight: level == 4 ? .semibold : .medium)
        }
    }
