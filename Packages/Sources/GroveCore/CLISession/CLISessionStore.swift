...
public actor CLISessionStore {
    ...
    /// Resolve the on-disk projects directory for a Grove-known cwd. Prefers
    ...
    /// found. Survives Grove-side rewrites (PickerExposer, LegacyMigrator) that
    ...
    /// jsonl itself doesn't carry the Grove project UUID.
